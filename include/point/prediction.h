...
class prediction {
 ...
 public:
  ...
  update_state(const float& time_offset_seconds, const Eigen::Vector3f& noise_0, const Eigen::Vector3f& noise_1) noexcept {
   ...
   prediction() noexcept : position_{Eigen::Vector3f::Zero()}, velocity_{Eigen::Vector3f::Zero()} {}
   prediction(const Eigen::Vector3f& position, const Eigen::Vector3f& velocity) noexcept
