...
struct particle_reduction_state {
  ...
  PARTICLE_FILTER_TARGET_ATTRS [[nodiscard]] constexpr const T& most_likely_particle() const noexcept { return most_likely_particle_; }
  ...
  PARTICLE_FILTER_TARGET_ATTRS [[nodiscard]] static constexpr particle_reduction_state<T> from_one_particle(const T& particle) noexcept {
